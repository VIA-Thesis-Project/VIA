...
## Corpus Check
- 329 files · ~174,304 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3373 nodes · 8735 edges · 217 communities (131 shown, 31 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1164 edges (avg confidence: 0.92)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `48d7049b`
...
Cohesion: 0.11
Nodes (16): IDefaultViabilityPolicyProvider, IDefaultViabilityPolicyStore, Protocol, Provide the current VIA default viability policy without owning its storage., Read and change the current default viability-policy pointer., EvaluateConfiguredDecisionSupport, StrEnum, Decision Support application query messages. (+8 more)
...
Cohesion: 0.12
Nodes (62): EnvironmentalInputReference, Caller-selected exact environmental dataset version., PostgreSQLEvaluationRepository, SessionFactory, Durable adapter for immutable Evaluation aggregates., clean_evaluations(), _common_support(), _comparable_crops() (+54 more)
...
Cohesion: 0.15
Nodes (39): CropLimitationEvidence, InvalidEngineOutputError, LimitingFactorEvidence, Durable opaque reference to one verified scientific artifact., Raised when the engine report does not satisfy the expected PoC contract., Current PoC parcel summary for the crop-suitability output., Portable grid identity needed to verify comparable scientific rasters., Transport-neutral aggregate for one limiting-factor code. (+31 more)
...
Cohesion: 0.10
Nodes (30): DecisionSupportResult, Prepared evidence plus an optional externally supplied policy evaluation., ConfiguredDecisionSupportResult, Configured Decision Support policy-selection workflow., Decision Support result together with the policy selection actually used., DomainValidationError, ValueError, Domain errors raised by Decision Support invariants. (+22 more)
...
Cohesion: 0.08
Nodes (26): EvidenceItem, IngestionReport, IngestionSourceResult, KnowledgeChunk, IDocumentTextExtractor, IKnowledgeChunker, build_retrieval_query(), _choose_boundary() (+18 more)
...
Cohesion: 0.11
Nodes (9): EmbeddingIndex, LexicalSearchHit, VectorSearchCandidate, IEmbeddingProvider, IKnowledgeCorpusRepository, UUID, _index(), _KnowledgeRepository (+1 more)
...
Cohesion: 0.07
Nodes (16): EnvironmentalInputResolutionError, Exception, RuntimeError, Raised when an exact caller-selected environmental version cannot be resolved., ActiveEvaluationResult, Logger, InvalidEvaluationTransitionError, Raised when an Evaluation lifecycle transition is not allowed. (+8 more)

### Community 37 - "test_agronomic_knowledge.py"
Cohesion: 0.10
Nodes (23): ExtractedDocument, ExtractedPage, DeterministicKnowledgeChunker, Page-aware deterministic chunker using recoverable headings and overlap., Decision Support infrastructure adapters., PyPdfDocumentTextExtractor, Native-text PDF extraction for the agronomic knowledge corpus., Extract native PDF text while preserving one-based page provenance. (+15 more)

### Community 38 - "EnvironmentalInputManifest"
Cohesion: 0.05
Nodes (71): EnvironmentalInputIntegrityError, Raised when resolved environmental provenance does not match scientific inputs., EnvironmentalInputManifest, EnvironmentalInputSnapshot, Immutable set of exact environmental inputs resolved for an evaluation., Historical environmental input metadata captured for one evaluation input., ConfiguredEnvironmentalInputIntegrityVerifier, CropSuiteEnvironmentalInputBinding (+63 more)
...
Cohesion: 0.08
Nodes (50): _availability(), CommonSupportReadResult, ComparableCropReadResult, CropEvidenceResult, CropLimitationResult, EvaluationLimitationsResult, EvaluationReadResult, EvaluationResultAvailability (+42 more)
...
Cohesion: 0.19
Nodes (20): GetPublishedDatasetVersion, PublishedDatasetVersion, PublishedDatasetVersionReader, Protocol, Stable contracts deliberately published to other bounded contexts., Public cross-context reader for exact immutable dataset versions., FakeEnvironmentalInformation, _dataset() (+12 more)

### Community 45 - "agroclimatic_evaluation/infrastructure/postgresql_repositories.py"
Cohesion: 0.09
Nodes (54): EvaluationConflictError, RuntimeError, Raised when an evaluation identity already exists., Durable scientific evidence referenced without exposing filesystem paths., Opaque engine-reported scientific source identity and SHA-256., ScientificArtifact, ScientificSourceFingerprint, Base (+46 more)
...
Cohesion: 0.10
Nodes (31): KnowledgeDocument, StoredChunk, IStoredChunkReader, Base, DeclarativeBase, SQLAlchemy metadata owned by Decision Support Infrastructure., Declarative base for Decision Support persistence records., DefaultViabilityPolicyRecord (+23 more)

### Community 64 - "require_test_database_url"
Cohesion: 0.19
...
Cohesion: 0.09
Nodes (34): CommonSupport, ComparableCrop, normalize_common_support_measurements(), One crop ranked on the exact common valid spatial support., Normalize impossible boundary overshoots caused only by float noise., Validate deterministic scientific ranking semantics., Spatial support shared by the usable crop suitability rasters., validate_comparable_crops() (+26 more)

### Community 70 - "RetrievedKnowledge"
Cohesion: 0.11
Nodes (25): RecommendationContext, RecommendationGeneration, RetrievalStatus, RetrievedKnowledge, IKnowledgeRetriever, IRecommendationGenerator, IRecommendationRepository, Protocol (+17 more)

### Community 72 - "app.py"
Cohesion: 0.11
Nodes (21): create_app(), create_production_app(), FastAPI, Side-effect-free FastAPI application composition., Build the production API after enforcing durable persistence settings., Build the VIA API and register its technical interfaces., configured_embedding_index(), KnowledgeContextUnavailableError (+13 more)
...
Cohesion: 0.07
Nodes (43): CoverageComputation, DatasetVersionConflictError, RuntimeError, Raised when a dataset version identifier has already been registered., DatasetVersion, Immutable reproducibility metadata for one dataset release., Positive horizontal and vertical source-cell resolution., SpatialResolution (+35 more)
...
Cohesion: 0.07
Nodes (51): _comparison_request(), Synchronous application orchestration for persisted evaluations., _to_common_support(), _to_comparable_crop(), _to_outcome(), CropComparisonExecutionError, CropComparisonInput, One durable crop suitability raster offered to scientific comparison. (+43 more)
...
### Community 150 - "CropExecutionStatus"
Cohesion: 0.24
Nodes (17): CropExecutionStatus, LimitationEvidenceAvailability, StrEnum, Scientific outcomes reported independently of Evaluation lifecycle state., Scientific artifact roles understood by VIA., Availability of deterministic SAME-RUN limiting-factor evidence., ScientificArtifactRole, _real_limitation_adapter() (+9 more)
...
Cohesion: 0.11
Nodes (24): Settings needed by the current backend composition root., Require the durable persistence contract used by the production API., Settings, MonkeyPatch, parametrize, Path, Tests for environment-driven application composition settings., _scientific_worker_settings() (+16 more)
...
Cohesion: 0.12
Nodes (10): DefaultViabilityPolicyNotConfiguredError, LookupError, Raised when VIA has no default viability policy configured., PolicyVersionConflictError, RuntimeError, Raised when one immutable policy reference is bound to different thresholds., Immutable identity and exact thresholds used for a policy execution., ViabilityPolicySnapshot (+2 more)

### Community 161 - "DomainValidationError"
Cohesion: 0.08
Nodes (28): _is_finite_number(), datetime, Immutable environmental input snapshots owned by Agroclimatic Evaluation., _validate_aware_datetime(), _validate_crs(), _validate_positive_number(), _validate_text(), DomainValidationError (+20 more)
...
### Community 174 - "FilesystemScientificArtifactStore"
Cohesion: 0.05
Nodes (81): CommonSupportResult, CommonSupportStatus, ComparableCropResult, CropComparisonRequest, CropComparisonResult, InvalidComparisonOutputError, Scientific common-support outcome across evaluated crops., Compare crop suitability only on identical valid spatial support. (+73 more)
...
### Community 176 - "knowledge_models.py"
Cohesion: 0.10
Nodes (23): EmbeddingBatch, EmbeddingVector, Provider-neutral models for agronomic knowledge retrieval and recommendations., RecommendationFactor, RecommendationItem, StructuredRecommendation, KnowledgeProviderUnavailableError, RuntimeError (+15 more)

### Community 177 - "PolicyReference"
Cohesion: 0.11
Nodes (32): DefaultViabilityPolicyConflictError, InvalidViabilityPolicyRevisionError, RuntimeError, ValueError, Application errors for Decision Support policy configuration., Raised when a requested persisted policy version does not exist., Raised when a requested viability-policy revision is not a new version., Raised when the default policy changed before an expected update. (+24 more)

### Community 178 - "config.py"
Cohesion: 0.26
Nodes (9): _environment_float(), _environment_integer(), _is_same_or_within(), _optional_path(), Path, Environment-backed configuration for the VIA application host., _validate_scientific_path_topology(), MonkeyPatch (+1 more)
...
Cohesion: 0.07
Nodes (57): EnvironmentalInputReferenceInput, ParcelSnapshotInput, Commands expressing Agroclimatic Evaluation use-case intent., Transport-neutral parcel state supplied by an authorized caller., RequestEvaluation, Agroclimatic Evaluation application layer., FinalizedCommonSupport, FinalizedCropLimitationEvidence (+49 more)

### Community 183 - "test_decision_support_postgresql.py"
Cohesion: 0.17
Nodes (29): PostgreSQLDefaultViabilityPolicyStore, PostgreSQLViabilityPolicyRepository, SessionFactory, Persist and resolve the singleton VIA default-policy pointer., Durable adapter for immutable viability-policy versions., clean_policy_versions(), database(), _database_url() (+21 more)
...
### Community 188 - "knowledge_ports.py"
Cohesion: 0.18
Nodes (19): CorpusManifest, CorpusSource, IKnowledgeSourceCatalog, Ports for the Decision Support agronomic knowledge subsystem., load_taxonomy(), _load_yaml_mapping(), ManifestValidationError, _optional_string() (+11 more)
...
### Community 198 - "test_agroclimatic_evaluation_queries.py"
Cohesion: 0.46
Nodes (7): _evaluation(), _outcome(), parametrize, Focused Application query tests for Agroclimatic Evaluation., _service(), test_finalized_public_contract_preserves_order_and_outcome_semantics(), test_public_contract_rejects_non_succeeded_evaluation()
...
### Community 201 - "RecommendationRun"
Cohesion: 0.13
Nodes (17): RecommendationRun, RecommendationStatus, RecommendationRunRecord, PostgreSQLRecommendationRepository, Persist recommendation generations and their closed evidence citations., _recommendation_run_from_record(), _structured_recommendation_to_dict(), _Builder (+9 more)

### Community 205 - "agroclimatic_evaluation/application/ports.py"
Cohesion: 0.10
Nodes (23): CropComparisonEngineError, CropSuitabilityEngineError, CropSuitabilityExecutionError, CropSuitabilityRequest, CropSuitabilityResult, RuntimeError, Application-owned boundary for one crop suitability evaluation., An engine-reported failure, distinct from no coverage and a zero score. (+15 more)
...
Cohesion: 0.20
Nodes (8): IEnvironmentalInputIntegrityVerifier, Verify resolved environmental provenance against scientific source fingerprints., Opaque scientific source identity and its engine-reported SHA-256., ScientificSourceFingerprint, Protocol, Publish immutable scientific files behind opaque logical references., ScientificArtifactStore, EngineRunner

### Community 214 - "decision_support/application/service.py"
Cohesion: 0.13
...
### Community 218 - "knowledge.py"
Cohesion: 0.23
Nodes (10): KnowledgeDocumentStatus, StrEnum, _DryRunRepository, main(), _parser(), ArgumentParser, Administrative CLI for the VIA agronomic knowledge corpus., Fail loudly if a dry run ever tries to touch persistence. (+2 more)

### Community 220 - "ICropComparisonEngine"
Cohesion: 0.33
Nodes (6): datetime, ICropComparisonEngine, ICropSuitabilityEngine, Protocol, Compare durable crop outputs using the authoritative scientific engine., Evaluate one crop without exposing engine process or filesystem details.
...
- **Why does `create_app()` connect `app.py` to `farm_management/application/service.py`, `Parcel`, `FarmManagementService`, `PostgreSQLEvaluationRepository`, `test_farm_management_postgresql.py`, `Settings`, `InMemoryEvaluationRepository`, `test_agroclimatic_evaluation_api.py`, `knowledge_models.py`, `config.py`, `DomainValidationError`, `agroclimatic_evaluation/application/__init__.py`, `test_environmental_information_api.py`, `knowledge_ports.py`, `test_farm_management_api.py`, `decision_support/infrastructure/postgresql_repositories.py`, `via_backend/worker.py`, `Dataset`, `Project`, `RetrievedKnowledge`, `RecommendationRun`, `EnvironmentalInformationService`, `DatasetVersion`?**
...
- **Why does `AgroclimaticEvaluationService` connect `agroclimatic_evaluation/application/__init__.py` to `DomainValidationError`, `test_agroclimatic_evaluation_api.py`, `Evaluation`, `test_agroclimatic_evaluation_queries.py`, `app.py`, `WaterRegime`, `execution.py`, `PostgreSQLEvaluationRepository`, `agroclimatic_evaluation/infrastructure/postgresql_repositories.py`, `agroclimatic_evaluation/application/ports.py`, `test_decision_support.py`?**
