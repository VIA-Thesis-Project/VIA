...
## Corpus Check
- 333 files · ~178,109 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3420 nodes · 8886 edges · 222 communities (132 shown, 35 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1187 edges (avg confidence: 0.92)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `948bef09`
...
Cohesion: 0.05
Nodes (120): include_name(), Alembic environment for VIA database migrations., Limit autogeneration to bounded-context-owned schemas., run_migrations_offline(), run_migrations_online(), EnvironmentalInputReference, Caller-selected exact environmental dataset version., EvaluationConflictError (+112 more)
...
Cohesion: 0.12
Nodes (57): LimitationEvidenceAvailability, Availability of deterministic SAME-RUN limiting-factor evidence., CropSuiteAdapter, Map a VIA snapshot to the preserved blocking CropSuiteLite capability., _adapter(), _default_base_config(), _environmental_input_manifest(), _geometry() (+49 more)
...
Cohesion: 0.10
Nodes (35): EvidenceItem, build_lexical_retrieval_query(), build_retrieval_query(), build_semantic_retrieval_query(), _choose_boundary(), _contiguous_section_spans(), _cosine_similarity(), _filter_low_value_lexical_hits() (+27 more)
...
Cohesion: 0.08
Nodes (17): CorpusSource, EmbeddingIndex, IngestionReport, IngestionSourceResult, KnowledgeChunk, IEmbeddingProvider, IKnowledgeChunker, IKnowledgeCorpusRepository (+9 more)
...
### Community 34 - "CropSuiteComparisonAdapter"
Cohesion: 0.30
...
Cohesion: 0.08
Nodes (17): datetime, Validate deterministic scientific ranking semantics., validate_comparable_crops(), InvalidEvaluationTransitionError, Raised when an Evaluation lifecycle transition is not allowed., Evaluation, EvaluationScenarioResult, WaterRegime (+9 more)

### Community 37 - "knowledge.py"
Cohesion: 0.13
Nodes (20): ExtractedDocument, ExtractedPage, IDocumentTextExtractor, DeterministicKnowledgeChunker, Page-aware deterministic chunker using recoverable headings and overlap., PyPdfDocumentTextExtractor, Native-text PDF extraction for the agronomic knowledge corpus., Extract native PDF text while preserving one-based page provenance. (+12 more)

### Community 38 - "EnvironmentalInputSnapshot"
Cohesion: 0.09
Nodes (43): EnvironmentalInputIntegrityError, Raised when resolved environmental provenance does not match scientific inputs., Opaque scientific source identity and its engine-reported SHA-256., ScientificSourceFingerprint, EnvironmentalInputSnapshot, Historical environmental input metadata captured for one evaluation input., ConfiguredEnvironmentalInputIntegrityVerifier, CropSuiteEnvironmentalInputBinding (+35 more)
...
Cohesion: 0.13
Nodes (30): EvaluationResultAvailability, StrEnum, Whether persisted outcomes are pending, partial, or final., StrEnum, Scientific water-regime assumption used for one CropSuite execution., WaterRegime, CommonSupportResponse, ComparableCropResponse (+22 more)
...
### Community 45 - "cropsuite_adapter.py"
Cohesion: 0.10
Nodes (54): CropLimitationEvidence, CropSuitabilityEngineError, CropSuitabilityExecutionError, InvalidEngineOutputError, LimitingFactorEvidence, Application-owned boundary for one crop suitability evaluation., Durable opaque reference to one verified scientific artifact., An engine-reported failure, distinct from no coverage and a zero score. (+46 more)
...
Cohesion: 0.10
Nodes (35): KnowledgeDocument, StoredChunk, Base, DeclarativeBase, SQLAlchemy metadata owned by Decision Support Infrastructure., Declarative base for Decision Support persistence records., DefaultViabilityPolicyRecord, EmbeddingIndexRecord (+27 more)

### Community 64 - "recovery.py"
Cohesion: 0.10
Nodes (20): EnvironmentalInputResolutionError, Exception, RuntimeError, Raised when an exact caller-selected environmental version cannot be resolved., _to_comparable_crop(), Explicit fail-only recovery for abandoned evaluation executions., CropOutcomeResult, EvaluationResult (+12 more)

### Community 65 - "scientific_artifact_store.py"
Cohesion: 0.18
Nodes (12): _file_identity(), _is_within(), PublishedScientificArtifact, Path, Durable filesystem storage for scientific artifacts., Raised when an immutable artifact reference already has different content., Verified local artifact available only inside Infrastructure., Storage result without exposing the filesystem root. (+4 more)

### Community 67 - "Dataset"
Cohesion: 0.14
Nodes (9): Dataset, Stable logical identity for a geoenvironmental dataset., DatasetRepository, DatasetVersionRepository, Protocol, UUID, InMemoryDatasetRepository, In-memory Environmental Information repository adapters. (+1 more)
...
Cohesion: 0.13
Nodes (29): CommonSupport, ComparableCrop, normalize_common_support_measurements(), One crop ranked on the exact common valid spatial support., Normalize impossible boundary overshoots caused only by float noise., Spatial support shared by the usable crop suitability rasters., _comparable_support(), _manifest() (+21 more)

### Community 70 - "RetrievedKnowledge"
Cohesion: 0.10
Nodes (23): RecommendationContext, RecommendationGeneration, RecommendationRun, RetrievedKnowledge, IKnowledgeRetriever, IRecommendationGenerator, IRecommendationRepository, IStoredChunkReader (+15 more)

### Community 72 - "WaterRegime"
Cohesion: 0.09
Nodes (30): Published water-regime values shared with consumer bounded contexts., WaterRegime, RecommendationFactor, _document_id(), _embedding_index_id(), KnowledgeContextUnavailableError, LookupError, UUID (+22 more)
...
Cohesion: 0.07
Nodes (32): CoverageComputation, DatasetVersionConflictError, RuntimeError, Raised when a dataset version identifier has already been registered., DatasetVersion, Immutable reproducibility metadata for one dataset release., Base, DeclarativeBase (+24 more)
...
### Community 135 - "EvaluationStatus"
Cohesion: 0.09
Nodes (26): Settings for the PostgreSQL polling worker process., WorkerSettings, ActiveEvaluationResult, EvaluationStatus, StrEnum, Architecture-approved lifecycle vocabulary., create_database(), Engine (+18 more)
...
Cohesion: 0.10
Nodes (42): Synchronous application orchestration for persisted evaluations., _to_common_support(), _to_outcome(), CommonSupportStatus, StrEnum, Evaluation-level scientific common-support result., Domain errors for Agroclimatic Evaluation., Agroclimatic Evaluation domain layer. (+34 more)
...
### Community 150 - "EnvironmentalInputManifest"
Cohesion: 0.15
...
Cohesion: 0.08
Nodes (38): EmbeddingBatch, EmbeddingVector, KnowledgeDocumentStatus, StrEnum, Provider-neutral models for agronomic knowledge retrieval and recommendations., RecommendationItem, RecommendationStatus, RetrievalStatus (+30 more)
...
### Community 160 - "DecisionSupportService"
Cohesion: 0.09
...
Cohesion: 0.10
Nodes (25): _is_finite_number(), datetime, Immutable environmental input snapshots owned by Agroclimatic Evaluation., _validate_aware_datetime(), _validate_crs(), _validate_positive_number(), _validate_text(), DomainValidationError (+17 more)
...
### Community 163 - "create_router"
Cohesion: 0.16
Nodes (19): EnvironmentalInputReferenceInput, ParcelSnapshotInput, Commands expressing Agroclimatic Evaluation use-case intent., Transport-neutral parcel state supplied by an authorized caller., RequestEvaluation, create_router(), get_evaluation(), get_evaluation_evidence() (+11 more)
...
Cohesion: 0.08
Nodes (25): _comparison_request(), CropComparisonInput, CropComparisonRequest, CropExecutionStatus, CropSuitabilityRequest, CropSuitabilityResult, ICropSuitabilityEngine, Protocol (+17 more)
...
Cohesion: 0.10
Nodes (28): LexicalSearchHit, VectorSearchCandidate, configured_embedding_index(), _Catalog, _context(), _Extractor, _FakeEmbeddings, _KnowledgeRepository (+20 more)
...
Cohesion: 0.08
Nodes (47): factor_display_label(), Human-readable labels for stable agroclimatic factor codes., Return the Spanish display label while preserving raw labels as fallback., Agroclimatic Evaluation application layer., FinalizedCropLimitationEvidence, FinalizedCropOutcome, FinalizedCropOutcomeStatus, FinalizedLimitationEvidenceAvailability (+39 more)
...
Cohesion: 0.16
Nodes (30): Fail one operator-confirmed orphaned active evaluation., RecoverEvaluation, AgroclimaticEvaluationRecoveryService, Mark an operator-confirmed active orphan as failed without retrying it., _evaluation(), _evaluation_in_status(), _manifest(), _outcome() (+22 more)
...
Cohesion: 0.12
Nodes (25): create_app(), create_production_app(), FastAPI, Side-effect-free FastAPI application composition., Build the production API after enforcing durable persistence settings., Build the VIA API and register its technical interfaces., CorpusManifest, Decision Support infrastructure adapters. (+17 more)
...
### Community 192 - "FilesystemScientificArtifactStore"
Cohesion: 0.22
Nodes (19): FilesystemScientificArtifactStore, RuntimeError, Base error for durable scientific artifact storage failures., Raised when published bytes do not match the expected scientific checksum., Filesystem-backed immutable artifact store., ScientificArtifactIntegrityError, ScientificArtifactStorageError, parametrize (+11 more)

### Community 193 - "InMemoryEvaluationRepository"
Cohesion: 0.21
Nodes (16): AgroclimaticEvaluationWorker, Discover queued IDs and delegate all execution semantics to Application., InMemoryEvaluationRepository, _artifact(), _engine_result(), _executor(), FakeEngine, test_claim_conflict_is_benign_and_later_work_continues() (+8 more)
...
Cohesion: 0.15
Nodes (12): CropComparisonEngineError, CropComparisonExecutionError, CropComparisonResult, ICropComparisonEngine, RuntimeError, Checked multicrop comparison returned by the scientific boundary., Base error for the scientific crop-comparison boundary., Raised when scientific common-support comparison cannot execute. (+4 more)
...
### Community 207 - "crop_suitability_main.py"
Cohesion: 0.18
...
### Community 209 - "test_environmental_information_domain.py"
Cohesion: 0.36
...
Cohesion: 0.21
Nodes (20): CommonSupportResult, CommonSupportStatus, ComparableCropResult, InvalidComparisonOutputError, Scientific common-support outcome across evaluated crops., Scientific support shared by all usable crop suitability rasters., One crop summarized on the exact common spatial support., Raised when scientific comparison returns an invalid contract. (+12 more)
...
- **Why does `create_app()` connect `app.py` to `FarmManagementService`, `farm_management/infrastructure/postgresql_repositories.py`, `EvaluationStatus`, `agroclimatic_evaluation/infrastructure/postgresql_repositories.py`, `EmbeddingIndex`, `Settings`, `knowledge_models.py`, `test_agroclimatic_evaluation_api.py`, `create_router`, `Parcel`, `test_agronomic_knowledge.py`, `agroclimatic_evaluation/application/__init__.py`, `test_environmental_information_api.py`, `test_farm_management_api.py`, `decision_support/infrastructure/postgresql_repositories.py`, `InMemoryEvaluationRepository`, `Dataset`, `Project`, `RetrievedKnowledge`, `WaterRegime`, `EnvironmentalInformationService`, `DatasetVersion`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `EnvironmentalInformationService` connect `EnvironmentalInformationService` to `Dataset`, `EvaluationStatus`, `DatasetVersion`, `GetPublishedDatasetVersion`, `test_environmental_information_coverage_postgresql.py`, `CoverageMeasurement`, `DomainValidationError`, `app.py`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `AgroclimaticEvaluationService` connect `agroclimatic_evaluation/application/__init__.py` to `recovery.py`, `DomainValidationError`, `test_agroclimatic_evaluation_api.py`, `create_router`, `Evaluation`, `EvaluationStatus`, `WaterRegime`, `WaterRegime`, `agroclimatic_evaluation/infrastructure/postgresql_repositories.py`, `test_agroclimatic_evaluation_queries.py`, `ParcelSnapshot`, `test_decision_support.py`, `app.py`?**
