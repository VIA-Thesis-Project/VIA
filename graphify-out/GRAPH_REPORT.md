...
## Corpus Check
- 288 files · ~128,139 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2520 nodes · 6077 edges · 192 communities (113 shown, 31 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 755 edges (avg confidence: 0.92)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e407beb3`
...
- test_environmental_information_public_contract.py
...
3. `EnvironmentalInformationService` - 47 edges
...
Cohesion: 0.08
Nodes (22): IDefaultViabilityPolicyProvider, Provide the current VIA default viability policy without owning its storage., EvaluateConfiguredDecisionSupport, EvaluateDecisionSupport, StrEnum, Decision Support application query messages., Prepare evidence and apply one explicitly versioned policy when possible., How the viability policy configuration is selected for one execution. (+14 more)

### Community 10 - "data_tools.py"
Cohesion: 0.13
Nodes (28): Interpolates or retrieves downscaled climate data (precipitation and…, extract_domain_from_global_3draster(), extract_domain_from_global_raster(), get_cpu_ram(), get_resolution_array(), get_shape_of_raster(), interpolate_nanmask(), load_specified_lines() (+20 more)
...
Cohesion: 0.15
Nodes (33): CropSuitabilityExecutionError, InvalidEngineOutputError, Raised when the existing engine service cannot produce a report., Raised when the engine report does not satisfy the expected PoC contract., Current PoC parcel summary for the crop-suitability output., Portable grid identity needed to verify comparable scientific rasters., An engine-reported failure, distinct from no coverage and a zero score., Trace metadata the current PoC can supply without invented versions. (+25 more)

### Community 16 - "climate_suitability_main.py"
Cohesion: 0.10
Nodes (28): calculate_average_sunshine(), calculate_day_length(), climate_suitability(), climsuit_new(), process_index(), find_max_sum_new(), get_lethal_max_precipitation(), get_lethal_min_precipitation_duration() (+20 more)
...
### Community 23 - "EvaluationResult"
Cohesion: 0.18
Nodes (12): EvaluationResult, ParcelSnapshotResult, InvalidCommandError, LookupError, RuntimeError, ValueError, Raised when a requested evaluation does not exist., Raised when request data violates an evaluation invariant. (+4 more)
...
Cohesion: 0.12
Nodes (31): _file_identity(), FilesystemScientificArtifactStore, _is_within(), PublishedScientificArtifact, Path, RuntimeError, Durable filesystem storage for scientific artifacts., Base error for durable scientific artifact storage failures. (+23 more)
...
Cohesion: 0.12
Nodes (23): # NOTE: self.extent is modified here to align with grid, calculate_suitabilities(), compute_combinations(), crop_rotation(), njit, get_geotiff_extent(), ndarray, Get the spatial extent (bounding box) of a GeoTIFF file. Args: file_path (str):… (+15 more)
...
Cohesion: 0.24
Nodes (10): ArgumentParser, create_worker(), main(), _parser(), UUID, Separate PostgreSQL polling-worker process and operator recovery CLI., Run explicit fail-only orphan recovery without composing CropSuiteLite., Compose the production worker and fail fast on missing scientific settings. (+2 more)
...
### Community 36 - "test_agroclimatic_evaluation_worker.py"
Cohesion: 0.17
Nodes (21): Fail one operator-confirmed orphaned active evaluation., RecoverEvaluation, AgroclimaticEvaluationRecoveryService, Mark an operator-confirmed active orphan as failed without retrying it., _evaluation(), _evaluation_in_status(), datetime, parametrize (+13 more)
...
Cohesion: 0.18
Nodes (7): Project, An agricultural project that groups parcels., ProjectRepository, Protocol, _project_from_record(), InMemoryProjectRepository, Process-local project storage for the first vertical slice.

### Community 39 - "CropSuiteComparisonAdapter"
Cohesion: 0.26
Nodes (18): CropSuiteComparisonAdapter, Compare persisted CropSuiteLite rasters on common valid support., Agroclimatic Evaluation infrastructure layer., _artifact(), Any, Path, _report(), _request() (+10 more)
...
Cohesion: 0.17
Nodes (19): CommonSupportResponse, ComparableCropResponse, CropEvidenceResponse, CropOutcomeResponse, EvaluationEvidenceResponse, EvaluationResponse, EvaluationResultResponse, EvaluationStatusResponse (+11 more)
...
Cohesion: 0.09
Nodes (41): _comparison_request(), CommonSupportResult, CommonSupportStatus, ComparableCropResult, CropComparisonEngineError, CropComparisonExecutionError, CropComparisonInput, CropComparisonRequest (+33 more)

### Community 45 - "test_environmental_information_postgresql.py"
Cohesion: 0.33
...
Cohesion: 0.08
Nodes (38): Synchronous application orchestration for persisted evaluations., _to_common_support(), _to_outcome(), Explicit fail-only recovery for abandoned evaluation executions., CropOutcomeResult, Transport-neutral Agroclimatic Evaluation results., Polling-worker coordination around the existing evaluation executor., CommonSupportStatus (+30 more)
...
Cohesion: 0.15
Nodes (22): CoverageComputation, Protocol, Application ports for Environmental Information spatial collaboration., Measure an external geometry against a registered dataset extent., SpatialCoveragePort, CoverageGeometry, _parse_multi_polygon(), _parse_polygon() (+14 more)
...
### Community 70 - "Parcel"
Cohesion: 0.08
Nodes (26): ParcelVersionConflictError, RuntimeError, Domain errors raised by Farm Management invariants., Raised when persisted parcel history changed before a revision was saved., Farm Management domain layer., Parcel, ParcelVersion, datetime (+18 more)

### Community 73 - "EnvironmentalInformationService"
Cohesion: 0.07
Nodes (59): CreateDataset, CreateDatasetVersion, Commands expressing Environmental Information use-case intent., Environmental Information application layer., PublishedDatasetVersion, Stable contracts deliberately published to other bounded contexts., GetDataset, GetDatasetVersion (+51 more)

### Community 74 - "main.py"
Cohesion: 0.07
Nodes (25): DatasetVersionConflictError, RuntimeError, Raised when a dataset version identifier has already been registered., Environmental Information infrastructure layer., PostGISCoverageCalculator, SessionFactory, Compare a supplied parcel geometry with a stored native-CRS extent., PostgreSQLDatasetVersionRepository (+17 more)

### Community 75 - "DatasetVersion"
Cohesion: 0.08
Nodes (36): Domain errors raised by Environmental Information invariants., Environmental Information domain layer., Dataset, DatasetVersion, Environmental Information domain model., Stable logical identity for a geoenvironmental dataset., Immutable reproducibility metadata for one dataset release., _validate_text() (+28 more)
...
Cohesion: 0.13
Nodes (30): ExecuteEvaluation, Request synchronous execution of one already-persisted evaluation., AgroclimaticEvaluationExecutionService, Exception, Execute requested crops and summarize them through Application-owned ports., EvaluationExecutor, Protocol, WorkerRunSummary (+22 more)
...
Cohesion: 0.11
Nodes (28): EnvironmentalInputSnapshot, _is_finite_number(), datetime, Immutable environmental input snapshots owned by Agroclimatic Evaluation., Historical environmental input metadata captured for one evaluation input., _validate_aware_datetime(), _validate_crs(), _validate_positive_number() (+20 more)

### Community 151 - "test_agroclimatic_evaluation_domain.py"
Cohesion: 0.19
Nodes (15): ParcelSnapshotInput, Commands expressing Agroclimatic Evaluation use-case intent., Transport-neutral parcel state supplied by an authorized caller., RequestEvaluation, request_evaluation(), _evaluation(), _polygon(), parametrize (+7 more)

### Community 154 - "Evaluation"
Cohesion: 0.08
Nodes (15): CommonSupport, Validate deterministic scientific ranking semantics., Spatial support shared by the usable crop suitability rasters., validate_comparable_crops(), InvalidEvaluationTransitionError, RuntimeError, Raised when an Evaluation lifecycle transition is not allowed., Evaluation (+7 more)

### Community 155 - "test_environmental_coverage.py"
Cohesion: 0.13
Nodes (14): get_suitability_val_dict(), process_day_climsuit_memopt(), Calculates the suitability value based on a specified formula for a given plant…, Processes climate suitability data for a specific day and saves the results to…, calculate_slope(), process_tempday_interp(), climate_coverage(), covered_gradient() (+6 more)
...
### Community 160 - "require_test_database_url"
Cohesion: 0.19
...
### Community 161 - "decision_support/application/service.py"
Cohesion: 0.10
Nodes (25): FinalizedEvaluationResultReader, Protocol, Public local interface for a future Decision Support consumer., IDecisionPolicy, Evaluate comparable evidence without changing its scientific values., DecisionSupportResult, DecisionSupportService, PolicyReferenceMismatchError (+17 more)

### Community 162 - "test_agroclimatic_evaluation_api.py"
Cohesion: 0.22
Nodes (24): _app_with(), _body(), _completed_outcomes(), _evaluation(), _evaluation_with_comparison(), _outcome(), Any, FastAPI (+16 more)

### Community 163 - "CropSuiteAdapter"
Cohesion: 0.20
Nodes (28): CropExecutionStatus, Scientific outcomes reported independently of Evaluation lifecycle state., CropSuiteAdapter, Map a VIA snapshot to the preserved blocking CropSuiteLite capability., _adapter(), Any, parametrize, Path (+20 more)
...
Cohesion: 0.18
Nodes (29): PostgreSQLEvaluationRepository, SessionFactory, Durable adapter for immutable Evaluation aggregates., clean_evaluations(), _common_support(), _comparable_crops(), database(), _database_url() (+21 more)
...
### Community 176 - ".measure"
Cohesion: 0.22
Nodes (8): InvalidSpatialInputError, RuntimeError, ValueError, Raised when supplied parcel geometry is not topologically usable., Raised when the configured spatial implementation cannot execute., SpatialCoverageUnavailableError, CoverageComputation, _srid_is_transformable()

### Community 177 - "PolicyReference"
Cohesion: 0.13
Nodes (28): InvalidViabilityPolicyRevisionError, ValueError, Raised when a requested viability-policy revision is not a new version., Decision Support application layer., Application lifecycle for immutable Decision Support viability policies., Register one explicitly identified immutable viability-policy version., Create a new immutable version derived from an existing policy identity., Coordinate registration and revision of immutable policy snapshots. (+20 more)

### Community 178 - "ScientificArtifactStore"
Cohesion: 0.29
Nodes (6): _is_within(), Path, Protocol, Publish immutable scientific files behind opaque logical references., ScientificArtifactStore, ComparisonRunner

### Community 180 - "ParcelSnapshot"
Cohesion: 0.11
Nodes (17): CropSuitabilityRequest, CropSuitabilityResult, ICropComparisonEngine, ICropSuitabilityEngine, Protocol, Compare durable crop outputs using the authoritative scientific engine., Evaluate one crop without exposing engine process or filesystem details., Transport-neutral input for evaluating one crop against an exact snapshot. (+9 more)
...
Cohesion: 0.20
Nodes (13): FinalizedCommonSupport, FinalizedCropOutcome, FinalizedCropOutcomeStatus, FinalizedEvaluationResult, FinalizedScientificTrace, FinalizedSuitabilitySummary, GetFinalizedEvaluationResult, StrEnum (+5 more)
...
Cohesion: 0.21
Nodes (15): AgroclimaticEvaluationWorker, Discover queued IDs and delegate all execution semantics to Application., InMemoryEvaluationRepository, Poll continuously, sleeping only after a non-full batch., run_forever(), _artifact(), _engine_result(), _executor() (+7 more)

### Community 185 - "test_environmental_information_public_contract.py"
Cohesion: 0.27
...
### Community 188 - "test_agroclimatic_evaluation_queries.py"
Cohesion: 0.52
...
- **Why does `AgroclimaticEvaluationService` connect `AgroclimaticEvaluationService` to `execution.py`, `test_decision_support.py`, `test_agroclimatic_evaluation_api.py`, `agroclimatic_evaluation/infrastructure/postgresql_repositories.py`, `agroclimatic_evaluation/interfaces/http.py`, `main.py`, `ParcelSnapshot`, `agroclimatic_evaluation/application/service.py`, `EvaluationResult`, `test_agroclimatic_evaluation_domain.py`, `DomainValidationError`, `Evaluation`, `agroclimatic_evaluation/application/__init__.py`, `test_agroclimatic_evaluation_queries.py`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `create_app()` connect `main.py` to `farm_management/application/service.py`, `test_agroclimatic_evaluation_api.py`, `farm_management/infrastructure/postgresql_repositories.py`, `PostgreSQLEvaluationRepository`, `Parcel`, `EnvironmentalInformationService`, `Project`, `DatasetVersion`, `FarmManagementService`, `test_environmental_information_api.py`, `test_farm_management_api.py`, `test_farm_management_postgresql.py`, `InMemoryEvaluationRepository`, `Settings`, `AgroclimaticEvaluationService`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `EnvironmentalInformationService` connect `EnvironmentalInformationService` to `DomainValidationError`, `main.py`, `DatasetVersion`, `SpatialExtent`, `.measure`, `CoverageMeasurement`, `test_environmental_information_public_contract.py`?**
